...
*/
  ...
  return (
    <div className="pl-[5%] pt-[50px] h-[100vh]">
      <Seo title="날씨" />
      {loading === true ? (
        <div>Loading...</div>
      ) : (
        <div className="h-[100%]">
          ...
          <div className="flex justify-center items-center">
            <div className="w-[40%]">
              <div className="w-[100%] h-[20%] text-center text-5xl">
                {data[dataIndex].MSRSTE_NM}
              </div>
              <div className="flex flex-wrap justify-center w-[100%] h-[100%]">
                <div className="w-[200px] h-[180px] bg-black p-5 rounded-2xl text-center flex flex-col items-center drop-shadow-md m-2">
                  <div className="font-bold text-lg text-white">미세먼지</div>

                  {data[dataIndex].PM10 === 0 ? (
                    <div className="mb-5 text-white">측정되지 않음</div>
                  ) : (
                    <div className="mb-5 text-white">
                      {data[dataIndex].PM10}㎍/m³
                    </div>
                  )}
                  {data[dataIndex].PM10 === 0 && (
                    <BsExclamationCircle size={50} color="white" />
                  )}
                ...
                <div className="w-[200px] h-[180px] bg-black p-5 rounded-2xl text-center flex flex-col items-center drop-shadow-md m-2">
                  <div className="font-bold text-lg text-white">초미세먼지</div>
                  {data[dataIndex].PM25 === 0 ? (
                    <div className="mb-5 text-white">측정되지 않음</div>
                  ) : (
                    <div className="mb-5 text-white">
                      {data[dataIndex].PM25}㎍/㎥
                ...
                <div className="w-[200px] h-[180px] bg-black p-5 rounded-2xl text-center flex flex-col items-center drop-shadow-md m-2">
                  <div className="font-bold text-lg text-white">오존</div>
                  {data[dataIndex].O3 === 0 ? (
                    <div className="mb-5 text-white">측정되지 않음</div>
                  ) : (
                    <div className="mb-5 text-white">
                  ...
                  {data[dataIndex].O3 > 0 && data[dataIndex].O3 <= 0.03 && (
                    <BsEmojiSmile size={50} color="#86efac" />
                  )}
                  {data[dataIndex].O3 > 0.03 && data[dataIndex].O3 <= 0.09 && (
                    <BsEmojiNeutral size={50} color="#fde047" />
                  )}
                  {data[dataIndex].O3 > 0.09 && data[dataIndex].O3 <= 0.15 && (
                    <BsEmojiFrown size={50} color="#fe9f51" />
                  )}
                  {data[dataIndex].O3 > 0.15 && (
                    <BsEmojiDizzy size={50} color="#f36767" />
                  )}
                </div>
                {weatherData === undefined ? (
                  ...
                  <div className="w-[200px] h-[180px] bg-black p-5 rounded-2xl text-center flex flex-col items-center drop-shadow-md m-2">
                    <div className="font-bold text-lg text-white">날씨</div>
                    <div className="mb-5 text-white">
            ...
            {/*<div className="w-[35%] h-[60%] bg-gray-100 p-5 rounded-3xl drop-shadow-md m-2">
          <div className="hover:cursor-pointer " onClick={handleBtnClick}>
            미세먼지 농도
          </div>
          <div className="hover:cursor-pointer " onClick={handleBtnClick}>
            초미세먼지 농도
