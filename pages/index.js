      ...
      <div className="pl-[5%] w-[95%]">
        ...
        <div className="flex">
          ...
          {loading === true ? (
            ...
            <div className="bg-white p-7 w-[20%] h-[40vh] rounded-3xl">
              <div className="text-center text-3xl">
                {data[dataIndex].MSRSTE_NM}
              </div>
              <div>미세먼지 {data[dataIndex].PM10}</div>
              <div>초미세먼지 {data[dataIndex].PM25}</div>
              <div>오존 {data[dataIndex].O3}</div>
              <div>통합대기환경등급 {data[dataIndex].IDEX_NM}</div>
              <div>측정시간 {data[dataIndex].MSRDT}</div>
            </div>
          )}
          <div className="bg-white p-7 w-[20%] h-[40vh] rounded-3xl">
            <div
